            ...
            <div className="mb-6 mt-2">
                <div className="flex items-center justify-between w-full mb-2 gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-1xl font-bold text-gray-800 text-left">Quản Lý Ngân Sách</h2>
                            <p className="text-gray-500 text-sm">Kiểm soát chi tiêu hàng tháng theo từng danh mục hiệu quả.</p>
                        </div>
                    </div>
